# Usuarios de Micafold — Investigación Completa
...
- **Lo que quiere de Micafold:** Pegar secuencia → ver la proteína → entender si es fiable → descargar para reunión.
...
- **Lo que quiere de Micafold:** Modelar la proteína mutada del paciente dentro del CESGA (datos que nunca salen del clúster institucional) y compararla con la sana.
...
- **Lo que quiere de Micafold:** Estructura 3D de la diana → identificar cavidades → descargar PDB para herramientas de docking externas.
...
- **Lo que quiere de Micafold:** Tooltips que expliquen el pLDDT. Flujo guiado. Resultados exportables para el TFM.

### Perfil E — El Investigador / Técnico del CESGA (Power User)
- Ya usa clusters HPC, pipelines, Slurm, Python, GROMACS. No necesita que Micafold prediga — ya tiene sus PDB.
...
**Con Micafold → 30 minutos:**
```
09:00 Pega el FASTA. Pulsa "Predecir". Espera 10 segundos.
09:15 Ve el resumen del ProteIA en lenguaje natural.
...
- ProteIA: *"La posición 1699 está en el dominio BRCT, crítico para reparación del ADN. Esta variante está clasificada como probablemente patogénica en ClinVar."*
...
Con Micafold en 10 minutos predice sus 5 candidatas y ve:
...
2. "¿Para qué me sirve?" → contexto biológico + ProteIA
...
| **Should have** | ProteIA (resumen LLM automático) | A, B, D |
...
│ ProteIA           │ Comparación con RMSD (split screen) │
