    ...
    <div className="max-w-4xl mx-auto px-5 py-8 w-full">
      ...
      <div className="flex flex-col sm:flex-row gap-2 mb-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-md border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 shrink-0 transition-all duration-200 ease-in-out active:scale-[0.98]"
        >
        ...
        <div className="relative shrink-0">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-md border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors w-full"
          >
        ...
        {!loading && visible.length > 0 && (
          <ul className="divide-y divide-slate-200 dark:divide-slate-700/60">
            {visible.map((job) => {
              ...
              return (
                <li key={job.id} className="group sm:grid sm:grid-cols-[1fr_120px_140px_128px] items-center gap-2 px-4 py-3 hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <div className="hidden sm:flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    {isCompleted && (
                      <>
                        ...
                        <button onClick={() => navigate(`/app?job=${job.cesgaJobId}`)} className="px-2.5 py-1 text-xs font-semibold rounded border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
                          Ver 3D
                        </button>
                      </>
                    )}
